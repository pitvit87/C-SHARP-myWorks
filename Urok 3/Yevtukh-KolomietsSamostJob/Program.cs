...
namespace Yevtukh_KolomietsSamostJob
{
    class Triangle // оголошеня класу
    {
        ...
        public Triangle(double x1, double y1, double x2, double y2, double x3, double y3) // конструктор з параметрами
        {
            ...
            this.x3 = x3;
            this.y3 = y3;
            numTriangle++;// підрахунок об'єктів класу тріангл
        }
        ...
        public void Print(string msg) // вивід на єкран
        {
            ...
            Write("(x2;y2)=(" + x2 + ";" + y2 + ")\n");
            Write("(x3;y3)=(" + x3 + ";" + y3 + ")\n");
            WriteLine("Num Triangle = "+ numTriangle + "\n");
        }
        ...
        internal class Program
        {
            static void Main(string[] args)
            {
                ...
                WriteLine(tr1.GetArea(tr1.p(Triangle.Length(2.3, 2.7, 5.7, 8.6), Triangle.Length(5.7, 8.6, 2.7, 5.8),
